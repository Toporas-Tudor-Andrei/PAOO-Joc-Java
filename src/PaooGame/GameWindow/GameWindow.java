...
public class GameWindow
{
    ...
    private EventHandler    eH;             /*!< Referinta event handler pentru player input*/
    ...
    /**
     * Inchide fereastra Jframe  jocului*/
    public void CloseWnd(){
        WindowEvent wev = new WindowEvent(wndFrame,WindowEvent.WINDOW_CLOSING);
        Toolkit.getDefaultToolkit().getSystemEventQueue().postEvent(wev);
        wndFrame.setVisible(false);
        wndFrame.dispose();
        System.exit(0);
    }
